document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawBranches(branch) {
        ...
        if (point1.d != -1 && point2.d != -1) {
            ...
            ctx.beginPath();
            ctx.strokeStyle = rgb(3 + trees[i].splits + pi / 2 / trees[i].height * branch.depth);
